...
Tendo a modificação da FuseNet na qual se manteve ligada apenas a fusão do CBR5, treinou-se esse modelo existoso com mais 340 épocas, em um total de 390 épocas, obtendo um total de $IoU = 40,58\%$. Os resultados dos testes desse modelo novamente treinado são discriminados na figura ~\ref{fig:resultados}.
